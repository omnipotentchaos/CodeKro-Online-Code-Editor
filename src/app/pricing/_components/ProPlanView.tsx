...
function ProPlanView() {
  const CHECKOUT_URL =
    "https://codekro.lemonsqueezy.com/buy/1ba3a153-ffd5-4d38-8b90-01d4c047ab02";
        ...
        <div className="relative max-w-xl mx-auto text-center">
          ...
          <div className="relative bg-[#12121a]/90 border border-gray-800/50 backdrop-blur-2xl rounded-2xl p-12">
            ...
            <div className="relative">
              ...
              <h1 className="text-3xl font-semibold text-white mb-3">Upgrade to Pro</h1>
              <p className="text-gray-400 mb-6 text-lg">
                Experience the full power of professional development
              </p>
              
              {/* QR Code Image */}
              <div className="mb-6 bg-white p-4 inline-block rounded-xl">
                <Image
                  src="/qr-code.png"
                  alt="Scan to upgrade to Pro"
                  width={180}
                  height={180}
              ...
              <Link
                href={CHECKOUT_URL}
                className="inline-flex items-center justify-center gap-2 w-full px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white rounded-xl transition-all duration-200 border border-blue-500/30 hover:border-blue-500/50 group"
              >
                <Command className="w-5 h-5 text-blue-100" />
                <span>Upgrade Now</span>
                <ArrowRight className="w-5 h-5 text-purple-100 group-hover:translate-x-0.5 transition-transform" />
              </Link>
            </div>
          </div>
        </div>
